...
const HeroSection = () => {
  return (
    ...
    <div className="w-full md:pt-32 relative h-[calc(75vh-64px)] md:h-[calc(100vh-128px)] bg-creamey">
      <div className="relative h-[80%] md:h-[75%] flex pb-[25vh] lg:pb-[15vh] justify-start lg:w-1/2 items-center sm:pb-[25vh] lg:justify-start lg:items-start">
        <motion.div
        ...
        >
          ...
          {/* <div className="absolute -bottom-[7vh] -left-[5vw] sm:-left-[4vw] lg:-left-[2vw]">
            <Image
              unoptimized
              className="-rotate-12"
              width={50}
