    ...
    <div className="w-full bg-creamey min-h-screen md:h-[150vh] flex max-md:ml-8  md:px-12 py-24 md:py-32">
      <div className=" max-sm:w-[40%] w-1/2 flex  lg:pl-16 xl:pl-32 flex-col justify-start md:items-start relative">
        ...
        <motion.h1
          ...
          className={` text-center text-lovely text-5xl md:text-7xl lg:text-9xl max-sm:mr-[10vw] font-normal ${lifeyFont.className}`}
        >
          plan
        </motion.h1>
        <motion.h1
      ...
      <div className="relative max-sm:w-[60%] w-1/2 flex flex-col justify-start lg:pt-[5vh] items-start md:items-center">
        ...
        >
          <motion.p
            ...
            className=""
          >
            Wifey for lifey is your ultimate bridal bestie ! From planning tools
            to stress-free tips, we&apos;ve got everything you need to make your
            dream home into a reality. it&apos;s not just about your home &
            gehaz-it&apos;s about you 💗
          </motion.p>
        </motion.div>
