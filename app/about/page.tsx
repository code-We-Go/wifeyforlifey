...
const AboutPage = () => {
  return (
    <div className={`container-custom flex justify-center  items-center min-h-[calc(100vh-128px)]  h-auto font-semibold text-lovely bg-creamey`}>
      <div className="w-full max-w-4xl py-8 lg:py-16 flex flex-col justify-center items-center gap-4 md:gap-8 lg:gap-16">
    ...
    viewport={{ once: true, amount: 0.3 }}
      ...
      className="text-start ">
        <h1 className={`${thirdFont.className} tracking-normal text-4xl md:text-5xl font-bold mb-4 md:mb-6 text-lovely`}>
        ❤️ About Wifey for Lifey
        </h1>
        <h4>We&apos;re not just here for your wedding—we&apos;re here for your womanhood.
        </h4>
        <p className="text-lg md:text-xl text-lovely/90 mb-4">
        ...
        <p className='text-lg md:text-xl'>We believe a woman&apos;s story doesn&apos;t end when she says &quot;I do.&quot; It&apos;s just beginning. That&apos;s why <span className='font-extrabold'>Wifey for Lifey</span> is evolving into an empowerment-driven lifestyle brand—one that supports women not just as brides, but as humans building homes, careers, families, and futures.
        </p>
    ...
    viewport={{ once: true, amount: 0.3 }}
      ...
      className="text-start ">
        <h1 className={`${thirdFont.className} tracking-normal text-3xl md:text-4xl font-semibold mb-4 md:mb-6 text-lovely`}>
        🌸 Why We&apos;re Here
        </h1>
        ...
        <p className='text-lg md:text-xl'>We want to build a<span className='font-extrabold'> womanhood empowerment empire</span>—yes, empire—where our content, products, and experiences uplift, equip, and emotionally support women with realness, warmth, and wisdom.
        </p>
...
Whether you’re planning your big day, starting a new chapter, or just trying to hold it all together—we’ve got you. With honest support, meaningful products, and a community that feels like home. </p>
        <p className='text-lg md:text-xl'>Welcome to your safe space, your planning partner, and your lifelong hype squad.

        </p>
        <p className='text-lg md:text-xl'>Welcome to <span className='font-extrabold'>Wifey for Lifey.</span>
