...
<p>
  At Wifey for Lifey, we care about your satisfaction and promise to handle any issues with fairness
  and clarity. Please read our return and exchange policy below.
</p>
...
<div>
  ...
  <ul>
    ...
    <li>You must report the issue within 24 hours of receiving your item.</li>
    <li>The item must be unused and returned in its original packaging.</li>
  </ul>
</div>
...
<div>
  ...
  <ul>
    <li>Approved refunds will be issued to your original payment method within 7 business days.</li>
    <li>Shipping costs are non-refundable unless the error was on our side.</li>
  </ul>
</div>
...
<div>
  ...
  <p>
    We do not offer product exchanges unless the wrong item was delivered to you.
  </p>
</div>
...
<div>
  ...
  <ul>
    <li>📧 Email: <a href="mailto:support@wifeyforlifey.com">support@wifeyforlifey.com</a></li>
    <li>📞 WhatsApp: [Insert Number]</li>
  </ul>
</div>

<p className='mt-4'>
  We appreciate your trust in Wifey for Lifey and are here to support you through any concerns.
</p>
