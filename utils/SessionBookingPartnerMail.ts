export function SessionBookingPartnerMail(
  sessionTitle: string,
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-top:10px;">
                                                                <div style="color:#d32333;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:1.2;text-align:left;mso-line-height-alt:19px;">
                                                                    <p style="margin: 0;">A new session has just been confirmed.<br>
                                                                    <strong>Session:</strong> ${sessionTitle}<br>
                                                                    <strong>Client name:</strong> ${clientName}<br>
                                                                    <strong>Client email:</strong> ${clientEmail}<br>
                                                                    ${
                                                                      clientPhone
                                                                        ? `<strong>Client phone:</strong> ${clientPhone}<br>`
                                                                        : ``
                                                                    }
                                                                    The client will contact you soon to set the session date.</p>
                                                                </div>
															</td>
														</tr>
													</table>
